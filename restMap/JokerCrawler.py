...
def crawlJoker():
    ...
    page = requests.get("https://joker.no/Finn-butikk/")
    base_url = "https://joker.no"
    ...
    for county in counties_list:
        ...
        for store in stores:
            ...
            try:
                ...
                phone_node = info_node.find("a", itemprop="telephone")
                phone = phone_node.get_text().replace("Tlf:", "").strip()
