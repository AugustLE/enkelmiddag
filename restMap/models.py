...
class StorePosition(models.Model):
    ...
    latitude = models.DecimalField(max_digits=20, decimal_places=6)
    longitude = models.DecimalField(max_digits=20, decimal_places=6)
    city = models.ForeignKey(City, related_name='storePositions', null=True, blank=True)
    county = models.ForeignKey(County, related_name='storeCountyPositions', null=True, blank=True)
